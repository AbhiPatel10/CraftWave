        ...
        <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
          ...
          <div className="flex flex-col md:flex-row">
            ...
            <div className='flex mt-5 md:mt-0'>
              ...
              <button onClick={()=>{addToCart(slug, 1, 499, product.title, size, color)}} className="flex ml-2 md:ml-14 text-white bg-pink-500 border-0 py-2 px-2 md:px-6 focus:outline-none hover:bg-pink-600 rounded">Add to Cart</button>
