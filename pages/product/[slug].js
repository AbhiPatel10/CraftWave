  ...
  return (
    ...
    <div className="container px-5 py-16 mx-auto">
      <div className="lg:w-4/5 mx-auto flex flex-wrap">
        <img alt="ecommerce" className="lg:w-1/2 w-full lg:h-auto h-full md:px-24 object-cover object-top rounded" src="https://m.media-amazon.com/images/I/41xFUgbP5ZL._UX679_.jpg" />
        <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
          <h2 className="text-sm title-font text-gray-500 tracking-widest">EPICWEAR</h2>
          <h1 className="text-gray-900 text-3xl title-font font-medium mb-1">Wear the Epic Way</h1>
          ...
          <div className="flex flex-col md:flex-row">
            ...
            <div className='flex mt-5 md:mt-0'>
              <button className="flex ml-2 md:ml-7 text-white bg-pink-500 border-0 py-2 px-2 md:px-6 focus:outline-none hover:bg-pink-600 rounded">Buy Now</button>
              
              <button onClick={()=>{addToCart(slug, 1, 499, 'epic wear', 'XL', 'Red')}} className="flex ml-2 md:ml-14 text-white bg-pink-500 border-0 py-2 px-2 md:px-6 focus:outline-none hover:bg-pink-600 rounded">Add to Cart</button>
