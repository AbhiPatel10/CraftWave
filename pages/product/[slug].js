        ...
        <div className="container px-5 py-16 mx-auto">
          <div className="lg:w-4/5 mx-auto flex flex-wrap justify-center">
            <Image
              ...
              width={300}
              height={400}
              className="m-auto object-cover object-top rounded"
              src={product.img}
            />
            ...
            */}
              ...
              <div className="flex flex-col md:flex-row">
                ...
                <div className="flex mt-5 md:mt-0">
                  <button
                    ...
                    className="flex ml-2 md:ml-7 text-white bg-pink-500 disabled:bg-pink-300 border-0 py-2 px-2 md:px-6 focus:outline-none hover:bg-pink-600 rounded"
                  >
                    Buy Now
                  </button>
                  ...
                  <button
                    ...
                    className="flex ml-2 md:ml-14 text-white bg-pink-500 disabled:bg-pink-300 border-0 py-2 px-2 md:px-6 focus:outline-none hover:bg-pink-600 rounded"
                  >
                    Add to Cart
                  </button>
              ...
              <div className="pin flex mt-6 space-x-2 text-sm">
                ...
                />
                <button
                  onClick={checkServiceavaibility}
