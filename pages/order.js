...
export async function getServerSideProps(context) {
  try {
    ...
    return {
      props: { order: JSON.parse(JSON.stringify(order)), error: JSON.parse(JSON.stringify(false)) }, // will be passed to the page component as props
    }
  } catch (error) {
    return {
      props: { order: JSON.parse(JSON.stringify({})), error: JSON.parse(JSON.stringify(error)) }, // will be passed to the page component as props
    }
  }
}
